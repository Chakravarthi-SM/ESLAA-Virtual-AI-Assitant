...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-50 px-6 py-2">
      ...
      {/* Hero Section */}
      <section className="relative z-10 px-6 pt-7 pb-32 flex items-center justify-center min-h-[calc(100vh-200px)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-xl rounded-full border border-cyan-500/20 mb-6">
            ...
            <p className="text-xl md:text-xl text-gray-300 mb-16 max-w-4xl mx-auto leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-10">
              ...
              {/* <button className="group flex items-center px-10 py-5 bg-white/5 backdrop-blur-xl rounded-2xl text-xl font-semibold border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative p-12 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl rounded-3xl border border-white/20">
            ...
            <div className="relative">
              ...
              <button
                onClick={() => navigate("/virtualassitant")}
                className="group relative px-12 py-6 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-2xl text-xl font-bold overflow-hidden transition-all duration-500 hover:scale-105 shadow-2xl shadow-cyan-500/25 cursor-pointer"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <span className="relative flex items-center">
                  Launch ESLAA
